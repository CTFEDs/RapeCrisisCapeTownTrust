	...
	public static function db_upgrade($db_version) {
		 ...
		 **/
			if ( version_compare($db_version, '3.4', '<') ) {
				...
				/* Change block and wrapper margins to Design Editor values */
					HeadwayElementsData::set_property('wrapper', 'margin-top', HeadwayOption::get('wrapper-top-margin', 'general', 30), 'structure');
					HeadwayElementsData::set_property('wrapper', 'margin-bottom', HeadwayOption::get('wrapper-bottom-margin', 'general', 30), 'structure');

					HeadwayElementsData::set_property('default-block', 'margin-bottom', HeadwayOption::get('block-bottom-margin', 'general', 10), 'default-elements');
